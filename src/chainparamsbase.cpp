...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    ...
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("testnet3", 18333);
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 48333);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 38333);
    case ChainType::REGTEST:
        return std::make_unique<CBaseChainParams>("regtest", 18444);
    }
    assert(false);
}
